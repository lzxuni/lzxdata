(function ($) {
    $.fn.powerWebUpload = function (options) {
        ...
        if (typeof WebUploader == 'undefined') {
            ...
            var casspath = "Content/js/plugins/webuploader-0.1.5/webuploader.css";
            $("<link>").attr({rel: "stylesheet", type: "text/css", href: casspath}).appendTo("head");
            var jspath = "Content/js/plugins/webuploader-0.1.5/webuploader.min.js";
            ...
            if (file.getStatus() === 'invalid') {
                ...
                uploader.makeThumb(file, function (error, src) {
                    ...
                    if (file.sytype == "update") {
                        var url = "<a class='fancybox' href='" + file.rep + "' title='图片1'><img alt='image' src='" + file.urlsPath + "' /></a>" +
                            "<input name='" + options.fileName + "' id='" + options.fileName + "'  type='hidden' value='" + JSON.stringify(file.fileAll) + "'>";
...
//            });
        ...
        uploader.on('uploadSuccess', function (file, response) {
            ...
            $(item.selector).find('#' + file.id).append("<input name='" + options.fileName + "' id='" + options.fileName + "' type='text' value='" + response.message + "'>");
            $(item.selector).find('#' + file.id + ' a').attr("href", img.urlPath);
        });
        //======================函数结束========================================
